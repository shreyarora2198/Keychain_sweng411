...
var MLKitCameraView = /** @class */ (function (_super) {
    ...
    MLKitCameraView.prototype.initView = function () {
        ...
        this.captureDevice = AVCaptureDeviceDiscoverySession.discoverySessionWithDeviceTypesMediaTypePosition([AVCaptureDeviceTypeBuiltInWideAngleCamera], AVMediaTypeVideo, this.preferFrontCamera ? 2 /* Front */ : 1 /* Back */).devices.firstObject;
        if (this.torchOn) {
            this.updateTorch();
        }
        // begin the session
