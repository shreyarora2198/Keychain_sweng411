...
var FieldValue = /** @class */ (function () {
    ...
    FieldValue.delete = function () { return "DELETE"; };
    FieldValue.arrayUnion = function (fields) { return new FieldValue("ARRAY_UNION", fields); };
    FieldValue.arrayRemove = function (fields) { return new FieldValue("ARRAY_REMOVE", fields); };
    return FieldValue;
}());
