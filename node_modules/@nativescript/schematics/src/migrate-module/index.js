...
const addModuleFile = (options) => (tree, context) => {
    const moduleOptions = {
        name: options.name,
        nsext: nsext,
        flat: false
    };
    return schematics_1.schematic('nativescript-module', moduleOptions)(tree, context);
};
const migrateComponents = (moduleInfo, project) => {
