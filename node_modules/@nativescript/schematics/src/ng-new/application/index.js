...
function default_1(options) {
    ...
    return schematics_1.chain([
        ...
        options.webpack ?
            schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./_webpack_files'), [
                schematics_1.template(Object.assign({}, options, { utils: utils_1.stringUtils, sourcedir, dot: '.' })),
                schematics_1.move(appPath),
            ])) :
            schematics_1.noop(),
