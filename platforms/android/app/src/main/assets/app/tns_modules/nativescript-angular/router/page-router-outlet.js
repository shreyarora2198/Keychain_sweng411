...
var platform_providers_2 = require("../platform-providers");
...
var PageRouterOutlet = /** @class */ (function () {
    function PageRouterOutlet(parentContexts, location, name, locationStrategy, componentFactoryResolver, resolver, changeDetector, device, pageFactory, routeReuseStrategy, elRef, frameService) {
    ...
    PageRouterOutlet.prototype.loadComponentInPage = function (page, componentRef) {
        ...
        page.on(page_1.Page.navigatedFromEvent, global.Zone.current.wrap(function (args) {
            if (args.isBackNavigation) {
                _this.locationStrategy._beginBackPageNavigation(_this.name, _this.frame);
                _this.locationStrategy.back();
            }
        }));
        var navOptions = this.locationStrategy._beginPageNavigation(this.name, this.frame);
    ...
    PageRouterOutlet.ctorParameters = function () { return [
        ...
        { type: platform_providers_2.FrameService }
    ]; };
