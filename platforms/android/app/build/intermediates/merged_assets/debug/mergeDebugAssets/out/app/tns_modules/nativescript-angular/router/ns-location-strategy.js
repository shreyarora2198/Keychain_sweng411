...
var NSLocationStrategy = /** @class */ (function (_super) {
    ...
    NSLocationStrategy.prototype.callPopState = function (state, pop) {
        ...
        var urlSerializer = new router_1.DefaultUrlSerializer();
        var rootOutlet = this.currentUrlTree.root.children[this.currentOutlet];
        if (state && rootOutlet) {
    ...
    NSLocationStrategy.prototype._beginBackPageNavigation = function (name, frame) {
        ...
        var cachedFrame = this.frameService.findFrame(frame).cachedFrame;
        if (cachedFrame) {
    ...
    NSLocationStrategy.prototype._beginModalNavigation = function (frame) {
        ...
        var cachedFrameRootOutlet = this.frameService.findFrame(frame).cachedFrameRootOutlet;
        var lastState = this.peekState(cachedFrameRootOutlet || this.currentOutlet);
        if (lastState) {
    ...
    NSLocationStrategy.prototype._beginCloseModalNavigation = function () {
        if (this._isModalClosing) {
            trace_1.routerError("Attempted to call startCloseModal while closing modal.");
            return;
        }
    ...
    NSLocationStrategy.prototype._finishCloseModalNavigation = function () {
        if (!this._isModalClosing) {
            trace_1.routerError("Attempted to call startCloseModal while not closing modal.");
            return;
        }
    ...
    NSLocationStrategy.prototype._beginPageNavigation = function (name, frame) {
